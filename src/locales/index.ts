export const translations = {
    ar: {
        ...
        auth: {
            ...
            addressPlaceholder: 'مثال: شارع الهرم، الجيزة',
            verificationTitle: 'تأكيد الحساب',
            verificationDesc: 'تم إرسال رمز مكون من 8 أرقام إلى بريدك الإلكتروني {email}',
            enterOtp: 'أدخلي رمز التحقق',
        ...
        client: {
            ...
            homePage: {
                welcome: 'مرحباً، {name}! 👋',
                description: 'ابحثي عن خالة موثوقة لأطفالك',
                searchPlaceholder: 'ابحثي عن خالة...',
                availableNow: 'متاحة الآن',
                busy: 'غير متاح حالياً',
                years: 'سنوات خبرة',
                perHour: 'جنيه/ساعة',
                reviews: 'تقييم',
                ...
                findingSitters: 'جاري البحث عن الخالات...',
            ...
            bookings: {
                ...
                reviewPlaceholder: 'شاركي تجربتك...',
                submit: 'إرسال',
                ...
                paymentSuccess: 'تم تأكيد الطلب بنجاح',
                chat: 'محادثة',
                scanQR: 'مسح الكود',
                ...
                or: 'أو',
                error: 'حدث خطأ',
                tapToRecord: 'اضغطي للتسجيل',
                thankYouReview: 'شكراً لتقييمك!',
                khalaLabel: 'الخالة : ',
                homeCare: 'رعاية منزلية',
                outsideCare: 'رعاية خارجية',
            ...
            sitterProfile: {
                ...
                successConfig: 'تم إرسال طلب الحجز بنجاح!',
                error: 'حدث خطأ أثناء الحجز',
                loginRequired: 'يجب عليك تسجيل الدخول أولاً',
                childAddedSuccess: 'تم إضافة الطفل بنجاح',
                childAddedError: 'حدث خطأ في إضافة الطفل',
                verificationRequiredMsg: 'يجب توثيق حسابك أولاً لإتمام الحجز. يرجى الذهاب لملفك الشخصي ورفع الهوية.',
                verificationCheckError: 'حدث خطأ أثناء التحقق من الحساب',
                selectDateError: 'يرجى اختيار تاريخ',
                enterAddressError: 'يرجى إدخال العنوان',
                outsideWorkingHours: 'الوقت المختار في تاريخ {date} يقع خارج ساعات عمل الخالة',
                perHourLabel: 'ساعة',
                available: 'متاح',
                noSlotsAvailable: 'لا توجد مواعيد متاحة في هذا اليوم',
                selectDateFirst: 'يرجى اختيار تاريخ أولاً',
                currentlyUnavailable: 'غير متاح للحجز حالياً',
                selectServiceTitle: 'اختاري الخدمة',
                serviceHourly: 'نظام بالساعة',
                serviceWeekly: 'تعاقد أسبوعي',
                serviceMonthly: 'تعاقد شهري',
                addAnotherChild: 'إضافة طفل آخر',
                newChildTitle: 'بيانات الطفل الجديد',
                childNamePlaceholder: 'اسم الطفل',
                childAgePlaceholder: 'العمر',
                confirm: 'تأكيد',
                extraCostNotice: 'سيتم احتساب تكلفة إضافية لهذا الطفل.',
                change: 'تغيير',
                saveAsDefault: 'حفظ هذا العنوان كعنوان افتراضي',
                yearsLabel: 'سنة',
                addressRequiredNotice: 'يجب إضافة عنوان لإتمام الحجز في المنزل'
            },
            paymentPage: {
                back: 'رجوع',
                payment: 'الدفع',
                ...
                verificationCodeSentMsg: 'تم إرسال كود التحقق إلى '
            },
            chatPage: {
            ...
            activeBookings: {
                ...
                call: 'اتصال',
                message: 'رسالة',
                wrongSitter: 'هذه ليست الخالة المطلوبة',
                wrongClient: 'هذه ليست العميلة المطلوبة',
                noActiveBookings: 'لا توجد طلبات جارية حالياً',
            ...
            trackingPage: {
                ...
                hourLabel: 'الساعة',
                verified: 'تم التحقق',
                liveTracking: 'متابعة الموقع لحظياً',
                sitterMoving: 'الخالة تتحرك الآن'
            }
        }
    },
    en: {
        ...
        auth: {
            ...
            addressPlaceholder: 'e.g. Haram St, Giza',
            verificationTitle: 'Verify Account',
            verificationDesc: 'A 8-digit code has been sent to your email {email}',
        ...
        client: {
            ...
            homePage: {
                ...
                description: 'Find a trusted sitter for your children',
                ...
                findingSitters: 'Finding sitters...',
                errorLoading: 'Error loading sitters',
                retry: 'Retry',
                guest: 'Guest',
            ...
            bookings: {
                ...
                thankYouReview: 'Thank you for your rating!',
                khalaLabel: 'Khala : ',
                homeCare: 'Home Care',
                outsideCare: 'Outside Care',
            ...
            sitterProfile: {
                ...
                successConfig: 'Booking request sent successfully!',
                error: 'Error creating booking',
                loginRequired: 'You must log in first',
                childAddedSuccess: 'Child added successfully',
                childAddedError: 'Error adding child',
                verificationRequiredMsg: 'Account verification required. Please go to your profile and verify your ID.',
                verificationCheckError: 'Error checking account status',
                selectDateError: 'Please select a date',
                enterAddressError: 'Please enter address',
                outsideWorkingHours: 'Selected time on {date} is outside sitter\'s available hours',
                perHourLabel: 'hour',
                available: 'Available',
                ...
                serviceHourly: 'Hourly',
                serviceWeekly: 'Weekly',
                serviceMonthly: 'Monthly',
                addAnotherChild: 'Add another child',
                newChildTitle: 'New Child Details',
                childNamePlaceholder: 'Child Name',
                childAgePlaceholder: 'Age',
                confirm: 'Confirm',
                extraCostNotice: 'Extra cost will apply for this child.',
                change: 'Change',
                saveAsDefault: 'Save as default address',
                yearsLabel: 'years',
                addressRequiredNotice: 'Address is required to complete home booking'
            },
            paymentPage: {
                back: 'Back',
                payment: 'Payment',
                ...
                verificationCodeSentMsg: 'Verification code sent to '
            },
            chatPage: {
            ...
            activeBookings: {
                ...
                call: 'Call',
                message: 'Message',
                wrongSitter: 'This is not the correct Sitter',
                wrongClient: 'This is not the correct Client',
            ...
            trackingPage: {
                ...
                sitterMoving: 'Sitter is currently moving'
            }
        }
    }
};
