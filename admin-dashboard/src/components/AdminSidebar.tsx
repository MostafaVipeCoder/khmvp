...
const AdminSidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, onLogout, allowedTabs }) => {
  const menuItems = [
    { id: 'dashboard', icon: LayoutDashboard, label: 'الإحصائيات الرئيسية' },
    { id: 'orders', icon: Calendar, label: 'الطلبات النشطة' },
    { id: 'add-order', icon: FilePlus, label: 'إضافة طلب' },
    ...
    { id: 'add-client', icon: UserPlus, label: 'إضافة عميل' },
